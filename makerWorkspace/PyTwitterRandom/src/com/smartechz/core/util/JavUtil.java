...
public class JavUtil {
	...
	public static ArrayList<String> getFields(Class objClass, Class retClass,
			int mod) throws IllegalArgumentException, IllegalAccessException {
	...
	@SuppressWarnings("rawtypes")
	public static ArrayList<String> getFieldsValues(Class objClass,
			Class retClass, int mod) throws IllegalArgumentException,
